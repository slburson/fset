...
(defun Test-Misc-3 ()
  ...
  (macrolet ((test (form)
	...
	(test (equal? rm (gmap (:result wb-replay-map) (fn (i) (at-index rm i)) (:arg index 0 (size rm)))))
...
(defun Test-2-Relations ()
  ...
  (macrolet ((test (form)
    ...
    (test (equal? (empty-2-relation) (empty-2-relation)))
    (test (empty? (empty-2-relation)))
    (test (eql (size (empty-2-relation)) 0))
    (test (eql (size (2-relation (2 3) (2 4) (2 5))) 3))
    (test (equal (multiple-value-list (arb (empty-2-relation))) '(nil nil nil)))
    (test (equal (multiple-value-list (arb (2-relation (1 2))))
                 '(1 2 t)))
    (test (contains? (2-relation (1 2) (1 3) (4 7)) 1 2))
    (test (not (contains? (2-relation (1 2)) 1 3)))
    (test (equal? (lookup (empty-2-relation) 1) (set)))
    (test (equal? (lookup (2-relation (1 2)) 1) (set 2)))
    (test (equal? (lookup-inv (2-relation (1 2)) 2) (set 1)))
    (test (equal? (domain (2-relation (1 2))) (set 1)))
    (test (equal? (range (2-relation (1 2))) (set 2)))
    (test (equal? (inverse (empty-2-relation)) (empty-2-relation)))
    (test (equal? (inverse (2-relation (1 2)))
                  (2-relation (2 1))))

    (test (equal (multiple-value-list (least (empty-2-relation)))
                 '(nil nil nil)))
    (test (equal? (multiple-value-list (least (2-relation (1 2) (3 4))))
                  (list 1 (set 2) t)))
    (test (equal (multiple-value-list (greatest (empty-2-relation)))
                 '(nil nil nil)))
    (test (equal? (multiple-value-list (greatest (2-relation (1 2) (3 4))))
                  (list 3 (set 4) t)))

    (test (= 1 (size (with (2-relation (1 2)) 1 2))))
    (test (equal? (2-relation (1 2) (1 3))
                  (inverse (2-relation (3 1) (2 1)))))
    (test (equal? (with (2-relation (1 2)) '(1 . 3))
                  (convert '2-relation '((1 . 2) (1 . 3)))))
    (test (equal? (with (2-relation (1 2)) 3 4)
                  (convert '2-relation '((1 . 2) (3 . 4)))))
    (test (equal? (with (2-relation (1 2) (5 3)) 4 3)
                  (convert '2-relation '((1 . 2) (5 . 3) (4 . 3)))))

    (test (equal? (less (empty-2-relation) 1 2) (empty-2-relation)))
    (test (equal? (less (2-relation (1 2)) '(1 . 2)) (empty-2-relation)))
    (test (equal? (less (2-relation (1 2)) 1 3)
                  (2-relation (1 2))))
    (test (equal? (less (2-relation (1 2) (1 3)) 1 3)
                  (2-relation (1 2))))
    (test (equal? (less (2-relation (2 1) (3 1)) 3 1)
                  (2-relation (2 1))))

    (test (equal? (union (empty-2-relation) (empty-2-relation)) (empty-2-relation)))
    (test (equal? (union (2-relation (1 2)) (empty-2-relation))
                  (2-relation (1 2))))
    (test (equal? (2-relation (1 2))
                  (union (2-relation (1 2)) (empty-2-relation))))
    (test (equal? (union (2-relation (1 2)) (2-relation (1 2)))
                  (2-relation (1 2))))
    (test (equal? (union (2-relation (1 2)) (2-relation (1 3)))
                  (2-relation (1 2) (1 3))))
    (test (equal? (union (2-relation (2 1)) (2-relation (3 1)))
                  (2-relation (2 1) (3 1))))
    (test (equal? (union (wb-custom-2-relation 'erapmoc 'erapmoc (3 1)) (2-relation (2 1)))
		  (wb-custom-2-relation 'erapmoc 'erapmoc (2 1) (3 1))))

    (test (equal? (intersection (empty-2-relation) (empty-2-relation)) (empty-2-relation)))
    (test (equal? (intersection (2-relation (1 2)) (empty-2-relation)) (empty-2-relation)))
    (test (equal? (intersection (empty-2-relation) (2-relation (1 2))) (empty-2-relation)))
    (test (equal? (intersection (2-relation (3 4)) (2-relation (1 2))) (empty-2-relation)))
    (test (equal? (intersection (2-relation (1 2)) (2-relation (1 2)))
                  (2-relation (1 2))))
    (test (equal? (intersection (2-relation (1 2)) (2-relation (1 3))) (empty-2-relation)))
    (test (equal? (intersection (2-relation (2 1)) (2-relation (3 1))) (empty-2-relation)))
    (test (equal? (intersection (2-relation ('a 7) ('b 12) ('c 17)) (2-relation ('b 12) ('c 22)))
		  (2-relation ('b 12))))
    (test (equal? (intersection (wb-custom-2-relation 'erapmoc 'erapmoc
						      ('a 7) ('b 12) ('c 17))
				(2-relation ('b 12) ('c 22)))
		  (wb-custom-2-relation 'erapmoc 'erapmoc ('b 12))))

    (test (equal? (join (2-relation ('a 3) ('a 5) ('b 7) ('b 8)) 1
			(2-relation (3 "yo") (7 "eek") (7 "mrr")) 0)
		  (2-relation ('a "yo") ('b "eek") ('b "mrr"))))
    ...
    (test (equal? (compose (2-relation ('a 3) ('a 5) ('b 3) ('c 4) ('c 8)) #'1+)
		  (2-relation ('a 4) ('a 6) ('b 4) ('c 5) ('c 9))))
    (test (equal? (compose (2-relation ('a 3) ('a 5) ('b 3) ('c 4) ('c 8))
			   (map (3 7) (4 6) (5 11) (8 15)))
		  (2-relation ('a 7) ('a 11) ('b 7) ('c 6) ('c 15))))

    (test (equal? (image (2-relation ('a 3) ('a 5) ('b 3) ('c 4) ('c 8))
			 (set 'a 'c))
		  (set (set 3 5) (set 4 8))))

    (test (equal? (convert 'list (2-relation ('a 3) ('a 5) ('b 7) ('b 8)))
		  '((a . 3) (a . 5) (b . 7) (b . 8))))
    (test (equal? (convert 'list (wb-custom-2-relation 'erapmoc 'erapmoc ('a 3) ('a 5) ('b 7) ('b 8)))
		  '((b . 8) (b . 7) (a . 5) (a . 3))))
    (test (equal? (gmap (:result list) #'cons
			(:arg 2-relation (wb-custom-2-relation 'erapmoc 'erapmoc ('a 3) ('a 5) ('b 7) ('b 8))))
		  '((b . 8) (b . 7) (a . 5) (a . 3))))
    (test (equal? (gmap (:result list) #'cons
			(:arg 2-relation (wb-2-relation ('a 3) ('a 5) ('b 7) ('b 8))))
		  '((a . 3) (a . 5) (b . 7) (b . 8))))
    (test (equal? (gmap (:result list) #'cons
    ...
    (test (equal? (convert 'set (wb-2-relation ('a 3) ('a 5) ('b 3) ('c 4)))
		  (set '(a . 3) '(a . 5) '(b . 3) '(c . 4))))
    (test (equal? (convert '2-relation (map ('a 5) ('b 3) ('c 4)))
		  (2-relation ('a 5) ('b 3) ('c 4))))
    (test (equal? (convert '2-relation (map ('a (set 3 5)) ('b (set 2)) ('c (set 4 7)))
			   :from-type 'map-to-sets)
		  (2-relation ('a 3) ('a 5) ('b 2) ('c 4) ('c 7))))
    (test (handler-case (progn
			  (convert 'map (2-relation ('a 3) ('b 2) ('c 4) ('c 7)))
			  nil)
	    (error () t)))
    (test (equal? (convert 'map (2-relation ('a 3) ('b 2) ('c 4)))
		  (map ('a 3) ('b 2) ('c 4))))
    (test (equal? (convert 'map-to-sets (2-relation ('a 3) ('a 5) ('b 3) ('c 4) ('c 8)))
		  (map ('a (set 3 5)) ('b (set 3)) ('c (set 4 8)))))

    (test (equal? (conflicts (2-relation ('a 3) ('a 5) ('b 3) ('c 4) ('c 8)))
		  (2-relation ('a 3) ('a 5) ('c 4) ('c 8))))

    (test (eq (compare (2-relation ('a 3) ('a 5) ('b 6) ('b 8))
		       (2-relation ('a 3) ('a 5) ('b 7) ('b 8)))
	      ':less))
    (test (eq (compare (2-relation ('a 3) ('a 5) ('b 7) ('b 8))
		       (2-relation ('a 3) ('a 5) ('b 6) ('b 8)))
	      ':greater))

    (test (equal? (transitive-closure (2-relation (1 3) (1 4) (3 7) (3 8) (4 11) (5 14) (6 12) (11 23))
				      (set 1))
		  (set 1 3 4 7 8 11 23)))
  ...
  (and (WB-Map-Tree-Verify (wb-2-relation-map0 br) #'compare)
	 ...
	 (and (Do-WB-Map-Tree-Pairs (x s (wb-2-relation-map0 br) t)
		...
		(or (null (wb-2-relation-map1 br))
			...
			(unless (WB-Set-Tree-Contains? s1 x #'compare)
...
(defun test-champ-maps (n)
  ...
  (macrolet ((test (form)
	...
	(let ((wbm (wb-map))
	  ...
	  (flet ((filter-mod-20 (x y)
		   (declare (ignore x))
		   (if (zerop (mod y 20))
		       (values nil ':no-value)
		     y)))
	    (when saved-chm
	      (let ((chm-union (map-union chm saved-chm #'filter-mod-20)))
		(test (verify chm-union))
		(let ((wbm-union (map-union wbm saved-wbm #'filter-mod-20))
	      ...
	      (let ((chm-intersection (map-intersection chm saved-chm #'filter-mod-20)))
		(test (verify chm-intersection))
		(let ((wbm-intersection (map-intersection wbm saved-wbm #'filter-mod-20))
